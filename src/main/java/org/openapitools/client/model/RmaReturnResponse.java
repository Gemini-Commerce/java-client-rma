...
public class RmaReturnResponse {
  ...
  private List<RmaReturnProduct> products;
  ...
  private List<RmaReturnHistory> history;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, grn, orderGrn, status, products, preferredRefundMethod, refundShippingCost, refundPaymentCost, customerInfo, returnAddress, note, history, createdAt, updatedAt, orderData);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaReturnResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaReturnResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
